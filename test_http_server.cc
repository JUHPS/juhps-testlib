...
void run() {
    ...
    //jujimeizuo::http::HttpServer::ptr server(new jujimeizuo::http::HttpServer(true, worker.get(), jujimeizuo::IOManager::GetThis()));
    ...
    sd->addServlet("/jujimeizuo/xx", [](jujimeizuo::http::HttpRequest::ptr req, jujimeizuo::http::HttpResponse::ptr rsp, jujimeizuo::http::HttpSession::ptr session) {
    ...
    sd->addGlobServlet("/jujimeizuox/*", [](jujimeizuo::http::HttpRequest::ptr req, jujimeizuo::http::HttpResponse::ptr rsp, jujimeizuo::http::HttpSession::ptr session) {
        rsp->setBody(XX(<html>
